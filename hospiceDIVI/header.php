...
<?php
/* mods
	zig Feb11, 2020 - add header-left-widget  Area
									= move cart totals
	...
	<?php if ( $et_top_info_defined && ! $et_slide_header || is_customize_preview() ) : ?>
		...
		<div id="top-header"<?php echo $et_top_info_defined ? '' : 'style="display: none;"'; ?>>
			...
			<?php endif; // true === $et_contact_info_defined ?>
			  <div id="hvhc-header-right">
					<?php
						if (is_active_sidebar('hvhc-header-right-widget')) {
							echo '<div id="hvhc-header-right-widget">';
								dynamic_sidebar( 'hvhc-header-right-widget');
							echo '</div>';
						}
						et_show_cart_total();
					?>
